...
df_magnificent_seven.to_csv("magnificent_seven.csv", index=False)
df_top_5_france.to_csv("top_5_france.csv", index=False)

df_ipo_2024.to_csv("ipo_2024.csv", index=False)
